  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <article className="max-w-[740px] mx-auto px-6 py-16 animate-fade-up">
          {/* Back Button */}
          <button
            onClick={() => window.history.back()}
            className="inline-flex items-center gap-2 font-barlow-condensed text-sm font-bold tracking-widest uppercase text-[var(--text3)] cursor-pointer border-none bg-transparent p-0 mb-8 transition-colors hover:text-[var(--acc)]"
          >
            <ArrowLeft size={14} />
            Volver
          </button>
          ...
          {/* Article Header */}
          <div className="font-barlow-condensed text-xs font-bold tracking-widest uppercase text-[var(--acc)] mb-4">
            {sectionLabel}
          </div>
          <h1 className="font-anton text-4xl lg:text-[4rem] leading-[0.97] text-[var(--head)] tracking-[0.01em] mb-4">
            {article.title}
          </h1>
          <p className="font-source-serif text-lg italic font-normal leading-[1.65] text-[var(--text2)] py-4 border-t border-b border-[var(--border)] mb-6">
            {article.excerpt}
          </p>
          <div className="flex items-center gap-4 flex-wrap font-barlow-condensed text-sm font-bold tracking-widest uppercase text-[var(--text3)] mb-8 pb-6 border-b-3 border-[var(--head)]">
          ...
          {/* Article Body */}
          <div className="font-source-serif text-base leading-[1.88] text-[var(--text)]">
            {article.body.split('\n\n').map((paragraph, index) => (
          ...
          <div className="flex items-center gap-3 mt-8 pt-8 border-t border-[var(--border)]">
            <button
              ...
              className="flex items-center gap-2 font-barlow-condensed text-xs font-bold tracking-widest uppercase text-[var(--text2)] border border-[var(--border)] px-4 py-2 cursor-pointer transition-all hover:border-[var(--head)] hover:text-[var(--head)]"
            >
